...
const MenuPage = () => {
  ...
  const hasAvailableItems = useMemo(
    () => visibleItems.some((item) => item.isAvailable !== false),
    [visibleItems]
  );
    ...
    <div className="min-h-screen bg-cream pb-28">
      <header className="sticky top-0 z-30 border-b border-brand/10 bg-cream/95 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <h1 className="max-w-[60%] truncate text-2xl font-semibold">
            {restaurantName}
          </h1>
        ...
        <div className="mx-auto flex max-w-5xl flex-nowrap gap-3 overflow-x-auto px-6 pb-4 scrollbar-hide">
      ...
      <main className="mx-auto max-w-5xl px-6 py-8">
        {isLoading ? (
          ...
          <>
            {!hasAvailableItems && (
              <div className="mb-6 flex flex-col items-center justify-center gap-2 text-sm text-gray-500">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-brand/10 bg-white shadow-sm pb-[env(safe-area-inset-bottom)]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <div>
